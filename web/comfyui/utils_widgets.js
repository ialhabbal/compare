...
export class CompareBaseWidget {
    constructor(name) {
        this.type = "custom";
        this.options = {};
        this.y = 0;
...
export class CompareBetterButtonWidget extends CompareBaseWidget {
...
export class CompareBetterTextWidget extends CompareBaseWidget {
...
export class CompareDividerWidget extends CompareBaseWidget {
...
export class CompareLabelWidget extends CompareBaseWidget {
...
export class CompareInvisibleWidget extends CompareBaseWidget {
